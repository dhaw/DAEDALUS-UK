...
nc=19;%Number of model compartments
solvetype=2;
hospInc=0;
...
if solvetype==2
    ...
    for i=1:lt-1
        ...
        if i==17
            ...
            % load('SR35.mat','data');
            % numInt=length(tvec)-2;
            % [pr,vx,~,~,~,~,~,~,~,~]=hePrepCoviddelta(data,numInt);    
...
yvar='Prev./hosp.';%'Susceptibles'; 'Hospitalisations';
solvetype=2;
